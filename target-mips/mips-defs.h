...
/**GDP**/
#define MIPS_CACHE_INDEX_WIDTH  3
#define MIPS_CACHE_INDEX_MASK   0x00000070
#define MIPS_CACHE_INDEX_SHIFT  4
#define MIPS_CACHE_TAG_SHIFT    7
#define MIPS_CACHE_TAG_WIDTH    25
#define MIPS_CACHE_OFFSET_MASK  0x0000000C
#define MIPS_CACHE_OFFSET_SHIFT 2
/**GDP**/
