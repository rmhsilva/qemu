...
/**GDP**/
#define MIPS_CACHE_INDEX_WIDTH  8
#define MIPS_CACHE_INDEX_MASK   0xFF0
#define MIPS_CACHE_INDEX_SHIFT  4
#define MIPS_CACHE_TAG_SHIFT    12
#define MIPS_CACHE_TAG_WIDTH    20
#define MIPS_CACHE_OFFSET_MASK  0xC
